...
import com.mvp.view.activity.FragmentActivity;
...
public class RequestUtil {
    ...
    private void getInstance(){
        ...
        if(mFile != null || mfileList != null || mfileMap != null){//先判断是否有文件，
            ...
            //设置参数
            switch (mMetyodType){
                case OkHttpUtils.METHOD_GET:
                    setGetParams();
                    break;
                case OkHttpUtils.METHOD_POST:
                    mRequestBuilder.post(getRequestBody());
                    break;
                case OkHttpUtils.METHOD_PUT:
                    mRequestBuilder.put(getRequestBody());
                    break;
                case OkHttpUtils.METHOD_DELETE:
