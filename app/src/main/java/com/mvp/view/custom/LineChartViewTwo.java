...
public class LineChartViewTwo extends MarkerView {
     ...
     * @param context
     */
    public LineChartViewTwo(Context context) {
    ...
    public void refreshContent(Entry e, Highlight highlight) {
        markerview_textview.setText((int)e.getX()+1+"月份" + "收益" + format.format(e.getY()) +"");
